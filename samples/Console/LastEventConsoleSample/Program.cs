...
public abstract class Program
{
    private static async Task Main()
    {
        ...
        // "dxfeed.system.properties" file, eliminating the need for a custom DXEndpoint instance. In this example,
        ...
        // in the "dxfeed.system.properties", establishing the connection automatically.
