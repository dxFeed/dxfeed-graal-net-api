// <copyright file="CandleMap.cs" company="Devexperts LLC">
...
/// <summary>
/// A class map for the <see cref="Candle"/> class, used to map CSV data to <see cref="Candle"/> objects.
/// </summary>
[SuppressMessage("ReSharper", "ClassNeverInstantiated.Global", Justification = "Created by CsvHelper")]
internal sealed class CandleMap : AbstractTimeSeriesMap<Candle>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CandleMap"/> class.
    /// This constructor configures the mapping rules for the <see cref="Candle"/> class.
    /// </summary>
    public CandleMap()
    {
